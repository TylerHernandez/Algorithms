...
// String[] fullText = new String[0]; // Start the array at 0 length in case
// given an empty list.

// // Until we've reached the end of the file, keep adding each line to our
// array.
...
// // Takes line of characters and puts them into fullText as a concatted
// string.
...
// System.out.println("Linear Search Average: " + new
// DecimalFormat("#.##").format((double) linearCounter / 42));
// System.out.println("Binary Search Average: " + new
// DecimalFormat("#.##").format((double) binaryCounter / 42));
...
// int currentComparisons = htable.arr[currentHashCode].findItem(item) + 1; // 1
// for the hash.
...
// // Performs a linearSearch for a target string over a given array. Returns
// index
...
// // Performs a binary search for a target string over a given Array,
// considering
...
// public static int binarySearch(String targetString, String[] givenArray, int
// minAddress, int maxAddress) {
// int foundAddress = -1; // Initializes at -1 in case not found.
...
// // Not in this part of the array, narrow down array bounds by 1/2 (lowering
// the
// // cieling).
